...
class PiecewiseLinear(Parameterization):
  values: np.ndarray
  x0: jnp.ndarray = dataclasses.field(default_factory=lambda: jnp.array(0.))
  x1: jnp.ndarray = dataclasses.field(default_factory=lambda: jnp.array(1.))
  y0: jnp.ndarray = dataclasses.field(default_factory=lambda: jnp.array(0.))
  y1: jnp.ndarray = dataclasses.field(default_factory=lambda: jnp.array(1.))
